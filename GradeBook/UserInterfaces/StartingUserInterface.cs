    ...
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            GradeBookUserInterface.CommandLoop(gradeBook);
            {
                if (gradeBook !=null)
                {
                    Console.WriteLine($"Created gradebook {parts[1]} of type {parts[2]}.");
                }
        ...
        public static void HelpCommand()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("Create Name Type - Creates a new gradebook where 'Name' is the name of the gradebook, grading type");
            Console.WriteLine();
